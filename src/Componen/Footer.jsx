...
function Footer() {
  return (
    <footer className="footercolo px-md-0 px-3" style={{ backgroundColor: "#1b443b" }}>
      <div className="container">
        <div className="row pt-5 pb-5 d-flex justify-content-around">
          ...
          <hr className="bg-white mt-sm-1 pt-sm-1" />
          <div className="row mt-3 d-flex justify-conten">
